...
const store_useStore = create((set) => ({
    count: 0,
...
const App = () => {
    const { count, increase, decrease } = store_useStore();
    return (react.createElement("div", { className: "app" },
        react.createElement("h1", null,
            "Counter: ",
            count),
        react.createElement("button", { onClick: increase }, "Increment"),
        react.createElement("button", { onClick: decrease }, "Decrement")));
};
...
const root = (0,client.createRoot)(document.getElementById('root'));
